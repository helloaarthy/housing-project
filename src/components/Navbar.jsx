    ...
    return (
        ...
        <nav className='navbarNav'>
            <ul className="navbarListItems">
                ...
                <ExploreIcon fill={patchMatchRoute('/')? '#2c2c2c': '#8f8f8f'} width='36px' height=''/>
                <p className={patchMatchRoute('/')? 'navbarListItemNameActive' : 'navbarListItemName'}>Explore</p>
                </li>
                <li className="navbarListItem" onClick={() => navigate('/offers')}>
                <OfferIcon fill={patchMatchRoute('/offers')? '#2c2c2c': '#8f8f8f'} width='36px' height=''/>
                <p className={patchMatchRoute('/offers')? 'navbarListItemNameActive' : 'navbarListItemName'}>Offers</p>
                </li>
                <li className="navbarListItem" onClick={() => navigate('/profile')}>
                <PersonOutlineIcon fill={patchMatchRoute('/profile')? '#2c2c2c': '#8f8f8f'} width='36px' height=''/>
